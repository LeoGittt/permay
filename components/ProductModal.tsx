...
export function ProductModal({
  ...
  const handleWhatsAppContact = () => {
    const phoneNumber = "5492614295880";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
              ...
              <div className="lg:col-span-3 space-y-2">
                ...
                <div className="flex gap-1 flex-wrap">
                  <Badge className="bg-permay-primary hover:bg-permay-primary/90 text-white px-3 py-1 text-sm font-bold rounded-md shadow-sm hover:shadow transition-all duration-200">
                    {product.brand}
                  </Badge>
                  <Badge
                    variant="outline"
                    className="px-2 py-0.5 text-xs font-normal rounded border border-gray-300 hover:border-permay-primary hover:bg-permay-primary hover:text-white transition-all duration-200"
                  >
              ...
              <div className="lg:col-span-2 space-y-4">
                      ...
                      <ChevronDown
                        className={`h-4 w-4 transition-all duration-300 text-gray-500 group-hover:text-permay-primary ${
                          isDescriptionExpanded
                            ? "rotate-180 text-permay-primary"
                            : ""
                        }`}
                      />
                    </Button>
                    ...
                    >
                      <div className="px-3 pb-3 border-t border-gray-100/60">
                        <div className="bg-white/60 rounded-lg p-3 mt-2">
                          <p className="text-gray-700 leading-relaxed text-sm font-normal whitespace-pre-wrap break-words">
                            {product.description}
                          </p>
                        </div>
                      </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-3 hover:border-gray-300 transition-colors duration-200">
                  <div className="text-center">
                    ...
                    <p className="text-2xl font-bold text-permay-primary">
